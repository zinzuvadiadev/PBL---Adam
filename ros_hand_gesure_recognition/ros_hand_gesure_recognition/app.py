...
def main():
    ...
    keypoint_classifier = KeyPointClassifier(app_folder + '/pbl_ws/src/ros_hand_gesture_recognition/src/model/keypoint_classifier/keypoint_classifier.tflite')

    point_history_classifier = PointHistoryClassifier(app_folder + '/pbl_ws/src/ros_hand_gesture_recognition/src/model/point_history_classifier/point_history_classifier.tflite')

    # Read labels ###########################################################
    with open(app_folder + '/pbl_ws/src/ros_hand_gesture_recognition/src/model/keypoint_classifier/keypoint_classifier_label.csv',
              encoding='utf-8-sig') as f:
        keypoint_classifier_labels = csv.reader(f)
        keypoint_classifier_labels = [
            row[0] for row in keypoint_classifier_labels
        ]
    with open(app_folder + '/pbl_ws/src/ros_hand_gesture_recognition/src/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
